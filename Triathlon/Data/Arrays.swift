...
""", work: "Тренер Tristyle", url: "https://www.instagram.com/tolkachev_1971/"),
...
""", work: "Тренер Tristyle", url: "https://www.instagram.com/dzmitry_meliakh/"),
...
""", work: "Тренер Tristyle", url: "https://www.instagram.com/dmitriikoptur/"),
...
// TEAM:
let teamArray: [HumanModel] = [HumanModel(photo: [UIImage(resource: .maksimova1)], name: "Анна Максимова", country: "🇧🇾", achievements: """
- МСМК по триатлону
...
""", work: "Спортсмен Tristyle", url: ""),
                               HumanModel(photo: [UIImage(resource: .shemelev1)], name: "Тихон Щемелев", country: "🇧🇾", achievements: """
