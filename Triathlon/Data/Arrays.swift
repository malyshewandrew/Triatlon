...
let partnerDiscountArray: [DiscountModel] = [DiscountModel(name: "Tristyle.Shop",
                                             ...
                                             DiscountModel(name: "Beurer",
                                                           description: "Скидка 10% на все немедицинские товары и 7% на медицинские товары.\nПо промокоду: tristyle",
                                                           percent: "7-10%",
...
let mutualDiscountArray: [DiscountModel] = [DiscountModel(name: "John Galt Studio",
                                            ...
                                            DiscountModel(name: "AKSTENT",
                                                          description: "Аренда и продажа тентовых конструкций и шатров.\nСкидка на все услуги.",
                                                          percent: "20%",
                                                          web: "https://akstent.com",
                                                          contact: "Андрей Коротенко"),
                                            DiscountModel(name: "NOVATION",
                                                          description: "Услуги по охране труда, лабораторные измерения.\nСкидка на все услуги в Беларуси и Минске.",
                                                          percent: "10%",
