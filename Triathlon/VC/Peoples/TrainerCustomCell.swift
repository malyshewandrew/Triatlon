...
class TrainerCustomCell: UITableViewCell {
    ...
    private let achievements = UILabel()
    ...
    private func addSubviews() {
        ...
        contenerView.addSubviews(nameLabel, surnameLabel, ageLabel, countryLabel, imageCollectionView, achievements, phoneButton, profileButton, workLabel)
    }
    ...
    private func configureConstreints() {
        ...
        achievements.translatesAutoresizingMaskIntoConstraints = false
        achievements.topAnchor.constraint(equalTo: imageCollectionView.bottomAnchor, constant: 10).isActive = true
        achievements.leadingAnchor.constraint(equalTo: contenerView.leadingAnchor, constant: 10).isActive = true
        achievements.widthAnchor.constraint(equalTo: contenerView.widthAnchor, multiplier: 0.4).isActive = true
        achievements.bottomAnchor.constraint(equalTo: contenerView.bottomAnchor, constant: -10).isActive = true
    ...
    private func setupUI() {
        ...
        achievements.font = fontMediumStandard14
        achievements.textColor = .white
        achievements.numberOfLines = .zero
        achievements.text = "Herous baba yaga  ex super herous baba yaga ex super herous baba yaga ex super herous baba yaga ex super herous baba yaga ex super herous baba yaga"
